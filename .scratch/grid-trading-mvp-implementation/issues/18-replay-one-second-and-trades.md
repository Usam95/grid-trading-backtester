# 18 — Replay `1s` and individual-trade evidence
...
**Blocked by:** 03 — Prove the manifested production-data tracer bullet; 05 — Persist and exactly replay one canonical decision path; 12 — Run conservative candle simulation through the canonical core; 13 — Build the frozen five-symbol production archive.
