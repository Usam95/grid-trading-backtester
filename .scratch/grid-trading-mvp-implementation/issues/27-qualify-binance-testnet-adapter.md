# 27 — Qualify the Binance Testnet adapter and generation
...
**Blocked by:** 11 — Admit only venue-valid positive grid-epoch plans; 12 — Transition safely between immutable grid epochs; 21 — Run one mode-isolated adaptive runtime against a fake venue; 22 — Admit authenticated idempotent operator commands; 23 — Explain runtime health, incidents and alerts; 24 — Reconcile ambiguity and restart frozen.
...
- [ ] The 14 accepted integration scenario families include guarded epoch transition and a tagged downtrend-recovery boundary, with deterministic fixtures where Testnet cannot naturally produce a safe partial/failure case.
